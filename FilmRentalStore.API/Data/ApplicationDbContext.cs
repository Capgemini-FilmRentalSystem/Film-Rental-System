...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.ActorId).HasName("PK__actor__8B2447B447014760");
        ...
        {
            entity.HasKey(e => e.AddressId).HasName("PK__address__CAA247C8C3EA1AD4");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__category__D54EE9B424787365");
        ...
        {
            entity.HasKey(e => e.CityId).HasName("PK__city__031491A855C49C96");
        ...
        {
            entity.HasKey(e => e.CountryId).HasName("PK__country__7E8CD0556465697B");
        ...
        {
            entity.HasKey(e => e.CustomerId).HasName("PK__customer__CD65CB853768EF4F");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film__349764A97290867E");
        ...
        {
            entity.HasKey(e => new { e.ActorId, e.FilmId }).HasName("PK__film_act__086D31FE0C4DA52F");
        ...
        {
            entity.HasKey(e => new { e.FilmId, e.CategoryId }).HasName("PK__film_cat__69C38A3283A13611");
        ...
        {
            entity.HasKey(e => e.FilmId).HasName("PK__film_tex__349764A9CC3A4680");
        ...
        {
            entity.HasKey(e => e.InventoryId).HasName("PK__inventor__B59ACC491A81A72C");
        ...
        {
            entity.HasKey(e => e.LanguageId).HasName("PK__language__804CF6B3ED01F321");
        ...
        {
            entity.HasKey(e => e.PaymentId).HasName("PK__payment__ED1FC9EAB2668D4F");
        ...
        {
            entity.HasKey(e => e.RentalId).HasName("PK__rental__67DB611B64A05C81");
        ...
        {
            entity.HasKey(e => e.StaffId).HasName("PK__staff__1963DD9C1774446D");
        ...
        {
            entity.HasKey(e => e.StoreId).HasName("PK__store__A2F2A30C0823885C");
